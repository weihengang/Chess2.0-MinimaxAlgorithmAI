...
last_move.width(5)
directory =__file__.replace("\PyChess2.0+MinimaxAlgorithmAI.py", "") #directory to load lichess chess images
...
def decode_fen(str):
    ...
    list_board.append(list_row)
    return list_board
list_piece =decode_fen("r1bqk2r/pppp1ppp/2n2n2/1Bb1p3/4P3/2N2N2/PPPP1PPP/R1BQK2R")
